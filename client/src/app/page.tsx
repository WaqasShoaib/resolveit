    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100">
      <div className="max-w-md w-full space-y-8 p-8">
        <div className="text-center">
          <h1 className="text-4xl font-bold text-gray-900 mb-2">ResolveIt</h1>
          <p className="text-gray-600 mb-8">Professional Dispute Resolution Platform</p>
        ...
        <div className="mt-8 text-center">
          ...
          <div className="space-y-2 text-sm text-gray-600">
            <p>✓ Professional Mediation Services</p>
            <p>✓ Secure Document Upload</p>
            <p>✓ Case Lifecycle Management</p>
            <p>✓ Expert Panel Formation</p>
          </div>
        </div>
      </div>
    </div>
